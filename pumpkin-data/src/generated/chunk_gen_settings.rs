...
impl GenerationSettings {
    pub const AMPLIFIED: GenerationSettings = GenerationSettings {
        ...
        surface_rule: MaterialRule::Sequence(SequenceMaterialRule {
            sequence: &[
                MaterialRule::Condition(ConditionMaterialRule {
                    if_true: MaterialCondition::VerticalGradient(VerticalGradientMaterialCondition {
                    ...
                    then_run: &MaterialRule::Block(BlockMaterialRule {
                        result_state: crate::Block::BEDROCK.default_state,
                    }),
                }),
                MaterialRule::Condition(ConditionMaterialRule {
                    if_true: MaterialCondition::AbovePreliminarySurface(
                        SurfaceMaterialCondition,
                    ),
                    then_run: &MaterialRule::Sequence(SequenceMaterialRule {
                        sequence: &[
                            MaterialRule::Condition(ConditionMaterialRule {
                                if_true: MaterialCondition::StoneDepth(StoneDepthMaterialCondition {
                                    offset: 0i32,
                                    add_surface_depth: false,
                                    secondary_depth_range: 0i32,
                                    surface_type: pumpkin_util::math::vertical_surface_type::VerticalSurfaceType::Floor,
                                }),
                                then_run: &MaterialRule::Sequence(SequenceMaterialRule {
                                    sequence: &[
                                        MaterialRule::Condition(ConditionMaterialRule {
                                            if_true: MaterialCondition::Biome(BiomeMaterialCondition {
                                                biome_is: &[&crate::biome::Biome::WOODED_BADLANDS],
                                            }),
                                            then_run: &MaterialRule::Condition(ConditionMaterialRule {
                                                if_true: MaterialCondition::YAbove(AboveYMaterialCondition {
                                                ...
                                                then_run: &MaterialRule::Sequence(SequenceMaterialRule {
                                                    sequence: &[
                                                        MaterialRule::Condition(ConditionMaterialRule {
                                                            if_true: MaterialCondition::NoiseThreshold(NoiseThresholdMaterialCondition {
                                                                noise: DoublePerlinNoiseParameters::SURFACE,
                                                                min_threshold: -0.909f64,
                                                                max_threshold: -0.5454f64,
                                                            }),
                                                            then_run: &MaterialRule::Block(BlockMaterialRule {
                                                                result_state: crate::Block::COARSE_DIRT.default_state,
                                                            }),
                                                        }),
                                                        MaterialRule::Condition(ConditionMaterialRule {
                                                            if_true: MaterialCondition::NoiseThreshold(NoiseThresholdMaterialCondition {
                                                                noise: DoublePerlinNoiseParameters::SURFACE,
                                                                min_threshold: -0.1818f64,
                                                                max_threshold: 0.1818f64,
                                                            }),
                                                            then_run: &MaterialRule::Block(BlockMaterialRule {
                                                                result_state: crate::Block::COARSE_DIRT.default_state,
                                                            }),
                                                        ...
                                                        MaterialRule::Condition(ConditionMaterialRule {
                                                            if_true: MaterialCondition::NoiseThreshold(NoiseThresholdMaterialCondition {
                                                                noise: DoublePerlinNoiseParameters::SURFACE,
                                                                min_threshold: 0.5454f64,
                                                                max_threshold: 0.909f64,
                                                            }),
                                                            then_run: &MaterialRule::Block(BlockMaterialRule {
                                                                result_state: crate::Block::COARSE_DIRT.default_state,
                                                            }),
                                                        ...
                                                        MaterialRule::Sequence(SequenceMaterialRule {
                                                            sequence: &[
                                                                MaterialRule::Condition(ConditionMaterialRule {
                                                                    ...
                                                                    then_run: &MaterialRule::Block(BlockMaterialRule {
                                                                        result_state: crate::Block::GRASS_BLOCK.default_state,
                                                                    }),
                                                                }),
                                                                MaterialRule::Block(BlockMaterialRule {
                                                                    result_state: crate::Block::DIRT.default_state,
                                                                }),
                                                            ],
                                                        }),
                                                    ],
                                        ...
                                        MaterialRule::Condition(ConditionMaterialRule {
                                            ...
                                            then_run: &MaterialRule::Condition(ConditionMaterialRule {
                                                ...
                                                then_run: &MaterialRule::Condition(ConditionMaterialRule {
                                                    if_true: MaterialCondition::Not(NotMaterialCondition {
                                                        invert: &MaterialCondition::YAbove(AboveYMaterialCondition {
                                                            anchor: YOffset::Absolute(pumpkin_util::y_offset::Absolute {
                                                                absolute: 63i16,
                                                            }),
                                                            surface_depth_multiplier: 0i32,
                                                    ...
                                                    then_run: &MaterialRule::Condition(ConditionMaterialRule {
                                                        ...
                                                        then_run: &MaterialRule::Block(BlockMaterialRule {
                                                            result_state: crate::Block::WATER.default_state,
                                                        }),
                                                    }),
                                                }),
                                            }),
                                            ...
                                            then_run: &MaterialRule::Sequence(SequenceMaterialRule {
                                                sequence: &[
                                                    MaterialRule::Condition(ConditionMaterialRule {
                                                        ...
                                                        then_run: &MaterialRule::Block(BlockMaterialRule {
                                                            result_state: crate::Block::ORANGE_TERRACOTTA.default_state,
                                                        }),
                                                    }),
                                                    MaterialRule::Condition(ConditionMaterialRule {
                                                        if_true: MaterialCondition::YAbove(AboveYMaterialCondition {
                                                        ...
                                                        then_run: &MaterialRule::Sequence(SequenceMaterialRule {
                                                            sequence: &[
                                                                MaterialRule::Condition(ConditionMaterialRule {
                                                                    ...
                                                                    then_run: &MaterialRule::Block(BlockMaterialRule {
                                                                        result_state: crate::Block::TERRACOTTA.default_state,
                                                                    }),
                                                                }),
                                                                MaterialRule::Condition(ConditionMaterialRule {
                                                                    if_true: MaterialCondition::NoiseThreshold(NoiseThresholdMaterialCondition {
                                                                ...
                                                                MaterialRule::Badlands(BadLandsMaterialRule),
                                                            ],
                                                        }),
                                                    }),
                                                    MaterialRule::Condition(ConditionMaterialRule {
                                                            ...
                                                            sequence: &[
                                                                MaterialRule::Condition(ConditionMaterialRule {
                                                                    if_true: MaterialCondition::StoneDepth(StoneDepthMaterialCondition {
                                                                        ...
                                                                        add_surface_depth: false,
                                                                        secondary_depth_range: 0i32,
                                                                        surface_type: pumpkin_util::math::vertical_surface_type::VerticalSurfaceType::Ceiling,
                                                                    }),
                                                                    then_run: &MaterialRule::Block(BlockMaterialRule {
                                                                        result_state: crate::Block::RED_SANDSTONE.default_state,
                                                                    }),
                                                                }),
                                                                MaterialRule::Block(BlockMaterialRule {
                                                                    result_state: crate::Block::RED_SAND.default_state,
                                                                }),
                                                            ],
                                                        }),
                                                    }),
                                                    MaterialRule::Condition(ConditionMaterialRule {
                                                        if_true: MaterialCondition::Not(NotMaterialCondition {
                                                            invert: &MaterialCondition::Hole(HoleMaterialCondition),
                                                        }),
                                                        then_run: &MaterialRule::Block(BlockMaterialRule {
                                                            result_state: crate::Block::ORANGE_TERRACOTTA.default_state,
                                                        }),
                                                    ...
                                                    MaterialRule::Condition(ConditionMaterialRule {
                                                        ...
                                                        then_run: &MaterialRule::Block(BlockMaterialRule {
                                                            result_state: crate::Block::WHITE_TERRACOTTA.default_state,
                                                        }),
                                                    }),
                                                    MaterialRule::Sequence(SequenceMaterialRule {
                                                        sequence: &[
                                                            MaterialRule::Condition(ConditionMaterialRule {
                                                                ...
                                                                then_run: &MaterialRule::Block(BlockMaterialRule {
                                                                    result_state: crate::Block::STONE.default_state,
                                                                }),
                                                            }),
                                                            MaterialRule::Block(BlockMaterialRule {
                                                                result_state: crate::Block::GRAVEL.default_state,
                                                            }),
                                                        ],
                                                    }),
                                                ],
                                    ...
                                    then_run: &MaterialRule::Sequence(SequenceMaterialRule {
                                        sequence: &[
                                            MaterialRule::Condition(ConditionMaterialRule {
                                                ...
                                                then_run: &MaterialRule::Condition(ConditionMaterialRule {
                                                    if_true: MaterialCondition::Hole(HoleMaterialCondition),
                                                    then_run: &MaterialRule::Sequence(SequenceMaterialRule {
                                                        sequence: &[
                                                            MaterialRule::Condition(ConditionMaterialRule {
                                                                if_true: MaterialCondition::Water(WaterMaterialCondition {
                                                                ...
                                                                then_run: &MaterialRule::Block(BlockMaterialRule {
                                                                    result_state: crate::Block::AIR.default_state,
                                                                }),
                                                            }),
                                                            MaterialRule::Condition(ConditionMaterialRule {
                                                                if_true: MaterialCondition::Temperature,
                                                                then_run: &MaterialRule::Block(BlockMaterialRule {
                                                                    result_state: crate::Block::ICE.default_state,
                                                                }),
                                                            }),
                                                            MaterialRule::Block(BlockMaterialRule {
                                                                result_state: crate::Block::WATER.default_state,
                                                ...
                                                sequence: &[
                                                    MaterialRule::Condition(ConditionMaterialRule {
                                                        ...
                                                        then_run: &MaterialRule::Sequence(SequenceMaterialRule {
                                                            sequence: &[
                                                                MaterialRule::Condition(ConditionMaterialRule {
                                                                    if_true: MaterialCondition::Steep,
                                                                    then_run: &MaterialRule::Block(BlockMaterialRule {
                                                                        result_state: crate::Block::PACKED_ICE.default_state,
                                                                    }),
                                                                }),
                                                                MaterialRule::Condition(ConditionMaterialRule {
                                                                    if_true: MaterialCondition::NoiseThreshold(NoiseThresholdMaterialCondition {
                                                                ...
                                                                MaterialRule::Condition(ConditionMaterialRule {
                                                                    ...
                                                                    then_run: &MaterialRule::Block(BlockMaterialRule {
                                                                        result_state: crate::Block::SNOW_BLOCK.default_state,
                                                                    }),
                                                                }),
                                                            ],
                                                        }),
                                                            ...
                                                            sequence: &[
                                                                ...
                                                                MaterialRule::Condition(ConditionMaterialRule {
                                                                    if_true: MaterialCondition::NoiseThreshold(NoiseThresholdMaterialCondition {
                                                                        ...
                                                                        min_threshold: 0.35f64,
                                                                        max_threshold: 0.6f64,
                                                                    }),
                                                                    then_run: &MaterialRule::Condition(ConditionMaterialRule {
                                                                        if_true: MaterialCondition::Water(WaterMaterialCondition {
                                                                            offset: 0i32,
                                                                        ...
                                                                        then_run: &MaterialRule::Block(BlockMaterialRule {
                                                                            result_state: crate::Block::POWDER_SNOW.default_state,
                                                                        }),
                                                                    }),
                                                                }),
                                                                MaterialRule::Condition(ConditionMaterialRule {
                                                        ...
                                                        sequence: &[
                                                                    ...
                                                                    sequence: &[
                                                                        MaterialRule::Condition(ConditionMaterialRule {
                                                                            if_true: MaterialCondition::NoiseThreshold(NoiseThresholdMaterialCondition {
                                                                                ...
                                                                                min_threshold: -0.0125f64,
                                                                                max_threshold: 0.0125f64,
                                                                            }),
                                                                            then_run: &MaterialRule::Block(BlockMaterialRule {
                                                                                result_state: crate::Block::CALCITE.default_state,
                                                                            }),
                                                                        }),
                                                                        MaterialRule::Block(BlockMaterialRule {
                                                                            result_state: crate::Block::STONE.default_state,
                                                                    ...
                                                                    sequence: &[
                                                                        MaterialRule::Condition(ConditionMaterialRule {
                                                                            if_true: MaterialCondition::NoiseThreshold(NoiseThresholdMaterialCondition {
                                                                                ...
                                                                                min_threshold: -0.05f64,
                                                                                max_threshold: 0.05f64,
                                                                            }),
                                                                            then_run: &MaterialRule::Sequence(SequenceMaterialRule {
                                                                                sequence: &[
                                                                                    MaterialRule::Condition(ConditionMaterialRule {
                                                            ...
                                                            MaterialRule::Condition(ConditionMaterialRule {
                                                                ...
                                                                then_run: &MaterialRule::Condition(ConditionMaterialRule {
                                                                    if_true: MaterialCondition::NoiseThreshold(NoiseThresholdMaterialCondition {
                                                                        noise: DoublePerlinNoiseParameters::SURFACE,
                                                                        min_threshold: 0.12121212121212122f64,
                                                                        max_threshold: ,
                                                                    }),
                                                                    then_run: &MaterialRule::Block(BlockMaterialRule {
                                                                        result_state: crate::Block::STONE.default_state,
                                                                ...
                                                                then_run: &MaterialRule::Sequence(SequenceMaterialRule {
                                                                    sequence: &[
                                                                        MaterialRule::Condition(ConditionMaterialRule {
                                                                            ...
                                                                            then_run: &MaterialRule::Block(BlockMaterialRule {
                                                                                result_state: crate::Block::SANDSTONE.default_state,
                                                                            }),
                                                                        }),
                                                                        MaterialRule::Block(BlockMaterialRule {
                                                                            result_state: crate::Block::SAND.default_state,
                                                                        }),
                                                                    ],
                                                                }),
                                                            }),
                                                        ...
                                                        then_run: &MaterialRule::Sequence(SequenceMaterialRule {
                                                            sequence: &[
                                                                MaterialRule::Condition(ConditionMaterialRule {
                                                                    if_true: MaterialCondition::NoiseThreshold(NoiseThresholdMaterialCondition {
                                                                        noise: DoublePerlinNoiseParameters::SURFACE,
                                                                        min_threshold: 0.21212121212121213f64,
                                                                        max_threshold: ,
                                                                    }),
                                                                    then_run: &MaterialRule::Block(BlockMaterialRule {
                                                                        result_state: crate::Block::STONE.default_state,
                                                                ...
                                                                MaterialRule::Condition(ConditionMaterialRule {
                                                                    if_true: MaterialCondition::NoiseThreshold(NoiseThresholdMaterialCondition {
                                                                        noise: DoublePerlinNoiseParameters::SURFACE,
                                                                        min_threshold: -0.06060606060606061f64,
                                                                        max_threshold: ,
                                                                    }),
                                                                    then_run: &MaterialRule::Block(BlockMaterialRule {
                                                                        result_state: crate::Block::COARSE_DIRT.default_state,
                                                        ...
                                                        then_run: &MaterialRule::Sequence(SequenceMaterialRule {
                                                            sequence: &[
                                                                MaterialRule::Condition(ConditionMaterialRule {
                                                                    if_true: MaterialCondition::NoiseThreshold(NoiseThresholdMaterialCondition {
                                                                        noise: DoublePerlinNoiseParameters::SURFACE,
                                                                        min_threshold: 0.24242424242424243f64,
                                                                        max_threshold: ,
                                                                    }),
                                                                    then_run: &MaterialRule::Sequence(SequenceMaterialRule {
                                                                        sequence: &[
                                                        ...
                                                        then_run: &MaterialRule::Sequence(SequenceMaterialRule {
                                                            sequence: &[
                                                                ...
                                                                MaterialRule::Condition(ConditionMaterialRule {
                                                                    if_true: MaterialCondition::NoiseThreshold(NoiseThresholdMaterialCondition {
                                                                        noise: DoublePerlinNoiseParameters::SURFACE,
                                                                        min_threshold: -0.11515151515151514f64,
                                                                        max_threshold: ,
                                                                    }),
                                                                    then_run: &MaterialRule::Block(BlockMaterialRule {
                                                                        result_state: crate::Block::PODZOL.default_state,
                                                                    }),
                                                                }),
                                                            ],
                                                        }),
                                                    ...
                                                    MaterialRule::Condition(ConditionMaterialRule {
                                                        ...
                                                        then_run: &MaterialRule::Block(BlockMaterialRule {
                                                            result_state: crate::Block::MUD.default_state,
                                                        }),
                                                    }),
                                                    MaterialRule::Condition(ConditionMaterialRule {
                                                        if_true: MaterialCondition::Biome(BiomeMaterialCondition {
                                                        ...
                                                        then_run: &MaterialRule::Block(BlockMaterialRule {
                                                            result_state: crate::Block::MYCELIUM.default_state,
                                                        }),
                                                    }),
                                                    MaterialRule::Sequence(SequenceMaterialRule {
                                                        sequence: &[
                                                        ...
                                                        then_run: &MaterialRule::Sequence(SequenceMaterialRule {
                                                            sequence: &[
                                                                ...
                                                                MaterialRule::Condition(ConditionMaterialRule {
                                                                    if_true: MaterialCondition::NoiseThreshold(NoiseThresholdMaterialCondition {
                                                                        noise: DoublePerlinNoiseParameters::POWDER_SNOW,
                                                                        min_threshold: 0.45f64,
                                                                        max_threshold: 0.58f64,
                                                                    }),
                                                                    then_run: &MaterialRule::Condition(ConditionMaterialRule {
                                                                        if_true: MaterialCondition::Water(WaterMaterialCondition {
                                                                            offset: 0i32,
                ...
                MaterialRule::Condition(ConditionMaterialRule {
                    ...
                    then_run: &MaterialRule::Block(BlockMaterialRule {
                        result_state: crate::Block::DEEPSLATE.default_state,
                    }),
                }),
            ],
        }),
    ...
    pub const CAVES: GenerationSettings = GenerationSettings {
        ...
        surface_rule: MaterialRule::Sequence(SequenceMaterialRule {
            sequence: &[
                MaterialRule::Condition(ConditionMaterialRule {
                    if_true: MaterialCondition::Not(NotMaterialCondition {
                        invert: &MaterialCondition::VerticalGradient(VerticalGradientMaterialCondition {
    ...
    pub const END: GenerationSettings = GenerationSettings {
        ...
        surface_rule: MaterialRule::Block(BlockMaterialRule {
            result_state: crate::Block::END_STONE.default_state,
        }),
    ...
    pub const NETHER: GenerationSettings = GenerationSettings {
        ...
        surface_rule: MaterialRule::Sequence(SequenceMaterialRule {
            sequence: &[
                ...
                MaterialRule::Condition(ConditionMaterialRule {
                    if_true: MaterialCondition::YAbove(AboveYMaterialCondition {
                        anchor: YOffset::BelowTop(pumpkin_util::y_offset::BelowTop {
                            below_top: 5i8,
                        }),
                        surface_depth_multiplier: 0i32,
                        add_stone_depth: false,
                    ...
                    then_run: &MaterialRule::Block(BlockMaterialRule {
                        result_state: crate::Block::NETHERRACK.default_state,
                    }),
                }),
                MaterialRule::Condition(ConditionMaterialRule {
                    if_true: MaterialCondition::Biome(BiomeMaterialCondition {
                    ...
                    then_run: &MaterialRule::Sequence(SequenceMaterialRule {
                        sequence: &[
                            MaterialRule::Condition(ConditionMaterialRule {
                                ...
                                then_run: &MaterialRule::Block(BlockMaterialRule {
                                    result_state: crate::Block::BASALT.default_state,
                                }),
                            }),
                            MaterialRule::Condition(ConditionMaterialRule {
                                if_true: MaterialCondition::StoneDepth(StoneDepthMaterialCondition {
                                ...
                                then_run: &MaterialRule::Sequence(SequenceMaterialRule {
                                    sequence: &[
                                        ...
                                        MaterialRule::Block(BlockMaterialRule {
                                            result_state: crate::Block::BLACKSTONE.default_state,
                                        }),
                                    ],
                                }),
                            }),
                                ...
                                then_run: &MaterialRule::Sequence(SequenceMaterialRule {
                                    sequence: &[
                                        MaterialRule::Condition(ConditionMaterialRule {
                                            ...
                                            then_run: &MaterialRule::Block(BlockMaterialRule {
                                                result_state: crate::Block::SOUL_SAND.default_state,
                                            }),
                                        }),
                                        MaterialRule::Block(BlockMaterialRule {
                                            result_state: crate::Block::SOUL_SOIL.default_state,
                                        }),
                                    ],
                                }),
                            }),
                        ...
                        sequence: &[
                            MaterialRule::Condition(ConditionMaterialRule {
                                ...
                                then_run: &MaterialRule::Condition(ConditionMaterialRule {
                                    if_true: MaterialCondition::Hole(HoleMaterialCondition),
                                    then_run: &MaterialRule::Block(BlockMaterialRule {
                                        result_state: crate::Block::LAVA.default_state,
                                    }),
                                }),
                            }),
                            MaterialRule::Condition(ConditionMaterialRule {
                                ...
                                then_run: &MaterialRule::Condition(ConditionMaterialRule {
                                    if_true: MaterialCondition::Not(NotMaterialCondition {
                                        invert: &MaterialCondition::NoiseThreshold(NoiseThresholdMaterialCondition {
                                            noise: DoublePerlinNoiseParameters::NETHERRACK,
                                            min_threshold: 0.54f64,
                                            max_threshold: ,
                                        }),
                                    }),
                                    then_run: &MaterialRule::Condition(ConditionMaterialRule {
                                            ...
                                            sequence: &[
                                                MaterialRule::Condition(ConditionMaterialRule {
                                                    if_true: MaterialCondition::NoiseThreshold(NoiseThresholdMaterialCondition {
                                                        ...
                                                        min_threshold: 1.17f64,
                                                        max_threshold: ,
                                                    }),
                                                    then_run: &MaterialRule::Block(BlockMaterialRule {
                                                        result_state: crate::Block::WARPED_WART_BLOCK.default_state,
                                                    }),
                                                }),
                                                MaterialRule::Block(BlockMaterialRule {
                                                    result_state: crate::Block::WARPED_NYLIUM.default_state,
                                                }),
                                            ],
                                        }),
                                    }),
                                        ...
                                        then_run: &MaterialRule::Sequence(SequenceMaterialRule {
                                            sequence: &[
                                                MaterialRule::Condition(ConditionMaterialRule {
                                                    ...
                                                    then_run: &MaterialRule::Block(BlockMaterialRule {
                                                        result_state: crate::Block::NETHER_WART_BLOCK.default_state,
                                                    }),
                                                }),
                                                MaterialRule::Block(BlockMaterialRule {
                                                    result_state: crate::Block::CRIMSON_NYLIUM.default_state,
                                                }),
                                            ],
                                        }),
                                    }),
