...
fn build_configured_features() -> std::collections::HashMap<
    pumpkin_data::configured_feature::ConfiguredFeature,
    ConfiguredFeature,
> {
    ...
    use crate::generation::block_state_provider::{
        ...
        RandomizedIntBlockStateProvider, RuleBasedBlockStateProvider,
        SimpleStateProvider, WeightedBlockStateProvider,
    };
    use pumpkin_util::math::pool::Weighted;
    use pumpkin_util::DoublePerlinNoiseParametersCodec;
    use crate::generation::rule::{
        RuleTest, block_match::BlockMatchRuleTest,
        block_state_match::BlockStateMatchRuleTest, tag_match::TagMatchRuleTest,
    ...
    use crate::generation::feature::placed_features::{
        Feature, PlacedFeature, PlacementModifier, BiomePlacementModifier,
        BlockFilterPlacementModifier, CountOnEveryLayerPlacementModifier,
        CountPlacementModifier, EnvironmentScanPlacementModifier,
        HeightRangePlacementModifier, HeightmapPlacementModifier,
        NoiseBasedCountPlacementModifier, NoiseThresholdCountPlacementModifier,
        RandomOffsetPlacementModifier, RarityFilterPlacementModifier,
        SquarePlacementModifier, SurfaceThresholdFilterPlacementModifier,
        SurfaceWaterDepthFilterPlacementModifier, PlacedFeatureWrapper,
    };
    use crate::generation::feature::features::{
        bamboo::BambooFeature, block_column::{BlockColumnFeature, Layer},
        end_spike::{EndSpikeFeature, Spike},
        fallen_tree::FallenTreeFeature,
        nether_forest_vegetation::NetherForestVegetationFeature,
        netherrack_replace_blobs::ReplaceBlobsFeature, ore::{OreFeature, OreTarget},
        random_boolean_selector::RandomBooleanFeature, random_patch::RandomPatchFeature,
        random_selector::{RandomFeature, RandomFeatureEntry},
        sea_pickle::SeaPickleFeature, seagrass::SeagrassFeature,
        simple_block::SimpleBlockFeature, simple_random_selector::SimpleRandomFeature,
        spring_feature::{BlockWrapper, SpringFeatureFeature},
        geode::GeodeFeature, tree::TreeFeature, vegetation_patch::VegetationPatchFeature,
        waterlogged_vegetation_patch::WaterloggedVegetationPatchFeature,
        tree::trunk::{
            TrunkPlacer, TrunkType, bending::BendingTrunkPlacer,
            cherry::CherryTrunkPlacer, dark_oak::DarkOakTrunkPlacer,
            fancy::FancyTrunkPlacer, forking::ForkingTrunkPlacer,
        ...
        tree::foliage::{
            FoliagePlacer, FoliageType, acacia::AcaciaFoliagePlacer,
            blob::BlobFoliagePlacer, bush::BushFoliagePlacer,
            cherry::CherryFoliagePlacer, dark_oak::DarkOakFoliagePlacer,
    ...
    map.insert(
        ...
        ConfiguredFeature::Geode(
            Box::new(GeodeFeature {
                ...
                inner_placements: vec![
                    { let mut props = std::collections::HashMap::new(); props
                    .insert("waterlogged".to_string(), "false".to_string()); props
                    .insert("facing".to_string(), "up".to_string()); BlockStateCodec {
                    name : & pumpkin_data::Block::SMALL_AMETHYST_BUD, properties :
                    Some(props), } }, { let mut props = std::collections::HashMap::new();
                    props.insert("waterlogged".to_string(), "false".to_string()); props
                    .insert("facing".to_string(), "up".to_string()); BlockStateCodec {
                    name : & pumpkin_data::Block::MEDIUM_AMETHYST_BUD, properties :
                    Some(props), } }, { let mut props = std::collections::HashMap::new();
                    props.insert("waterlogged".to_string(), "false".to_string()); props
                    .insert("facing".to_string(), "up".to_string()); BlockStateCodec {
                    name : & pumpkin_data::Block::LARGE_AMETHYST_BUD, properties :
                    Some(props), } }, { let mut props = std::collections::HashMap::new();
                    props.insert("waterlogged".to_string(), "false".to_string()); props
                    .insert("facing".to_string(), "up".to_string()); BlockStateCodec {
                    name : & pumpkin_data::Block::AMETHYST_CLUSTER, properties :
                    Some(props), } }
                ],
                cannot_replace: BlockWrapper::Single(
                    "#minecraft:features_cannot_replace".to_string(),
                ),
                invalid_blocks: BlockWrapper::Single(
                    "#minecraft:geode_invalid_blocks".to_string(),
                ),
                filling: 1.7f64,
                inner_layer: 2.2f64,
                middle_layer: 3.2f64,
                ...
                outer_wall_distance: IntProvider::Object(
                    NormalIntProvider::Uniform(UniformIntProvider {
                        min_inclusive: 4i32,
                        max_inclusive: 6i32,
                    }),
                ),
                distribution_points: IntProvider::Object(
                    NormalIntProvider::Uniform(UniformIntProvider {
                        min_inclusive: 3i32,
                        max_inclusive: 4i32,
                    }),
                ),
                point_offset: IntProvider::Object(
                    NormalIntProvider::Uniform(UniformIntProvider {
                        min_inclusive: 1i32,
                        max_inclusive: 2i32,
                    }),
            ...
            Box::new(TreeFeature {
                ...
                trunk_placer: TrunkPlacer {
                    ...
                    r#type: TrunkType::Bending(BendingTrunkPlacer {
                        ...
                        bend_length: IntProvider::Object(
                            NormalIntProvider::Uniform(UniformIntProvider {
                                min_inclusive: 1i32,
                                max_inclusive: 2i32,
                            }),
                ...
                foliage_provider: BlockStateProvider::Weighted(WeightedBlockStateProvider {
                    entries: vec![
                        Weighted { data : { let mut props =
                        std::collections::HashMap::new(); props.insert("waterlogged"
                        .to_string(), "false".to_string()); props.insert("persistent"
                        .to_string(), "false".to_string()); props.insert("distance"
                        .to_string(), "7".to_string()); BlockStateCodec { name : &
                        pumpkin_data::Block::AZALEA_LEAVES, properties : Some(props), }
                        .get_state() }, weight : 3i32 }, Weighted { data : { let mut
                        props = std::collections::HashMap::new(); props
                        .insert("waterlogged".to_string(), "false".to_string()); props
                        .insert("persistent".to_string(), "false".to_string()); props
                        .insert("distance".to_string(), "7".to_string()); BlockStateCodec
                        { name : & pumpkin_data::Block::FLOWERING_AZALEA_LEAVES,
                        properties : Some(props), } .get_state() }, weight : 1i32 }
                    ],
                }),
                foliage_placer: FoliagePlacer {
    ...
    map.insert(
        ...
        ConfiguredFeature::RandomSelector(RandomFeature {
            features: vec![
                ...
                PlacedFeatureWrapper::Named(pumpkin_data::placed_feature::PlacedFeature::FancyOakChecked),
                chance : 0.05f32 }, RandomFeatureEntry { feature :
                PlacedFeatureWrapper::Named(pumpkin_data::placed_feature::PlacedFeature::JungleBush),
                chance : 0.15f32 }, RandomFeatureEntry { feature :
                PlacedFeatureWrapper::Named(pumpkin_data::placed_feature::PlacedFeature::MegaJungleTreeChecked),
                chance : 0.7f32 }
            ],
            default: Box::new(
                PlacedFeatureWrapper::Direct(PlacedFeature {
                    ...
                    placement: vec![
                        ...
                        predicates :
                        vec![BlockPredicate::MatchingBlockTag(MatchingBlockTagPredicate {
                        offset : OffsetBlocksBlockPredicate { offset : None }, tag :
                        ...
                        { offset : OffsetBlocksBlockPredicate { offset :
                        Some(Vector3::new(0i32, - 1i32, 0i32)) }, blocks :
                        MatchingBlocksWrapper::Single("minecraft:podzol".to_string()),
                        })), })], }) })
                    ],
                }),
            ),
    ...
    map.insert(
        ...
        ConfiguredFeature::BasaltPillar(crate::generation::feature::features::basalt_pillar::BasaltPillarFeature {}),
    );
    map.insert(
    ...
    map.insert(
        ...
        ConfiguredFeature::Tree(
            Box::new(TreeFeature {
                ...
                decorators: vec![
                    TreeDecorator::Beehive(BeehiveTreeDecorator { probability : 0.002f32
                    }), TreeDecorator::PlaceOnGround(PlaceOnGroundTreeDecorator { tries :
                    96i32, radius : 4i32, height : 2i32, block_state_provider :
                    BlockStateProvider::Weighted(WeightedBlockStateProvider { entries :
                    vec![Weighted { data : { let mut props =
                    std::collections::HashMap::new(); props.insert("segment_amount"
                    .to_string(), "1".to_string()); props.insert("facing".to_string(),
                    "north".to_string()); BlockStateCodec { name : &
                    pumpkin_data::Block::LEAF_LITTER, properties : Some(props), }
                    .get_state() }, weight : 1i32 }, Weighted { data : { let mut props =
                    std::collections::HashMap::new(); props.insert("segment_amount"
                    .to_string(), "1".to_string()); props.insert("facing".to_string(),
                    "east".to_string()); BlockStateCodec { name : &
                    pumpkin_data::Block::LEAF_LITTER, properties : Some(props), }
                    .get_state() }, weight : 1i32 }, Weighted { data : { let mut props =
                    std::collections::HashMap::new(); props.insert("segment_amount"
                    .to_string(), "1".to_string()); props.insert("facing".to_string(),
                    "south".to_string()); BlockStateCodec { name : &
                    pumpkin_data::Block::LEAF_LITTER, properties : Some(props), }
                    .get_state() }, weight : 1i32 }, Weighted { data : { let mut props =
                    std::collections::HashMap::new(); props.insert("segment_amount"
                    .to_string(), "1".to_string()); props.insert("facing".to_string(),
                    "west".to_string()); BlockStateCodec { name : &
                    pumpkin_data::Block::LEAF_LITTER, properties : Some(props), }
                    .get_state() }, weight : 1i32 }, Weighted { data : { let mut props =
                    std::collections::HashMap::new(); props.insert("segment_amount"
                    .to_string(), "2".to_string()); props.insert("facing".to_string(),
                    "north".to_string()); BlockStateCodec { name : &
                    pumpkin_data::Block::LEAF_LITTER, properties : Some(props), }
                    .get_state() }, weight : 1i32 }, Weighted { data : { let mut props =
                    std::collections::HashMap::new(); props.insert("segment_amount"
                    ...
                    .get_state() }, weight : 1i32 }, Weighted { data : { let mut props =
                    std::collections::HashMap::new(); props.insert("segment_amount"
                    .to_string(), "3".to_string()); props.insert("facing".to_string(),
                    "north".to_string()); BlockStateCodec { name : &
                    pumpkin_data::Block::LEAF_LITTER, properties : Some(props), }
                    .get_state() }, weight : 1i32 }, Weighted { data : { let mut props =
                    std::collections::HashMap::new(); props.insert("segment_amount"
                    ...
                    "west".to_string()); BlockStateCodec { name : &
                    pumpkin_data::Block::LEAF_LITTER, properties : Some(props), }
                    .get_state() }, weight : 1i32 }], }), }),
                    TreeDecorator::PlaceOnGround(PlaceOnGroundTreeDecorator { tries :
                    150i32, radius : 2i32, height : 2i32, block_state_provider :
                    BlockStateProvider::Weighted(WeightedBlockStateProvider { entries :
                    vec![Weighted { data : { let mut props =
                    std::collections::HashMap::new(); props.insert("segment_amount"
                    .to_string(), "1".to_string()); props.insert("facing".to_string(),
                    ...
                    .get_state() }, weight : 1i32 }, Weighted { data : { let mut props =
                    std::collections::HashMap::new(); props.insert("segment_amount"
                    .to_string(), "4".to_string()); props.insert("facing".to_string(),
                    "north".to_string()); BlockStateCodec { name : &
                    pumpkin_data::Block::LEAF_LITTER, properties : Some(props), }
                    .get_state() }, weight : 1i32 }, Weighted { data : { let mut props =
                    std::collections::HashMap::new(); props.insert("segment_amount"
    ...
    map.insert(
        ...
        ConfiguredFeature::Tree(
            Box::new(TreeFeature {
                ...
                decorators: vec![
                    TreeDecorator::Beehive(BeehiveTreeDecorator { probability : 0.02f32
                    })
                ],
                root_placer: None,
            }),
    ...
    map.insert(
        ...
        ConfiguredFeature::Tree(
            Box::new(TreeFeature {
                ...
                decorators: vec![
                    TreeDecorator::Beehive(BeehiveTreeDecorator { probability : 0.05f32
                    })
                ],
                root_placer: None,
            }),
    ...
    map.insert(
        ...
        ConfiguredFeature::RandomSelector(RandomFeature {
            features: vec![
                RandomFeatureEntry { feature :
                PlacedFeatureWrapper::Named(pumpkin_data::placed_feature::PlacedFeature::FallenSuperBirchTree),
                chance : 0.00625f32 }, RandomFeatureEntry { feature :
                PlacedFeatureWrapper::Named(pumpkin_data::placed_feature::PlacedFeature::SuperBirchBees0002),
                chance : 0.5f32 }, RandomFeatureEntry { feature :
                PlacedFeatureWrapper::Named(pumpkin_data::placed_feature::PlacedFeature::FallenBirchTree),
                chance : 0.0125f32 }
            ],
            default: Box::new(
                PlacedFeatureWrapper::Named(
    ...
    map.insert(
        ...
        ConfiguredFeature::BlueIce(crate::generation::feature::features::blue_ice::BlueIceFeature {}),
    );
    map.insert(
        pumpkin_data::configured_feature::ConfiguredFeature::BonusChest,
        ConfiguredFeature::BonusChest(crate::generation::feature::features::bonus_chest::BonusChestFeature {}),
    );
    map.insert(
    ...
    map.insert(
        ...
        ConfiguredFeature::BlockColumn(BlockColumnFeature {
            layers: vec![
                ...
                { min_inclusive : 1i32, max_inclusive : 3i32 })), provider :
                BlockStateProvider::Simple(SimpleStateProvider { state : { let mut props
                = std::collections::HashMap::new(); props.insert("age".to_string(), "0"
                .to_string()); BlockStateCodec { name : & pumpkin_data::Block::CACTUS,
                properties : Some(props), } .get_state() } }) }, Layer { height :
                ...
                weight : 3i32 }, WeightedEntry { data : IntProvider::Constant(1i32),
                weight : 1i32 }] })), provider :
                BlockStateProvider::Simple(SimpleStateProvider { state :
                pumpkin_data::Block::CACTUS_FLOWER.default_state }) }
            ],
    ...
    map.insert(
        ...
        ConfiguredFeature::BlockColumn(BlockColumnFeature {
            layers: vec![
                ...
                min_inclusive : 0i32, max_inclusive : 19i32 })), weight : 2i32 },
                WeightedEntry { data :
                IntProvider::Object(NormalIntProvider::Uniform(UniformIntProvider {
                min_inclusive : 0i32, max_inclusive : 2i32 })), weight : 3i32 },
                WeightedEntry { data :
                IntProvider::Object(NormalIntProvider::Uniform(UniformIntProvider {
                min_inclusive : 0i32, max_inclusive : 6i32 })), weight : 10i32 }] })),
                provider : BlockStateProvider::Weighted(WeightedBlockStateProvider {
                entries : vec![Weighted { data : { let mut props =
                std::collections::HashMap::new(); props.insert("berries".to_string(),
                "false".to_string()); BlockStateCodec { name : &
                pumpkin_data::Block::CAVE_VINES_PLANT, properties : Some(props), }
                .get_state() }, weight : 4i32 }, Weighted { data : { let mut props =
                std::collections::HashMap::new(); props.insert("berries".to_string(),
                "true".to_string()); BlockStateCodec { name : &
                pumpkin_data::Block::CAVE_VINES_PLANT, properties : Some(props), }
                .get_state() }, weight : 1i32 }], }) }, Layer { height :
                IntProvider::Constant(1i32), provider :
                ...
                { entries : vec![Weighted { data : { let mut props =
                std::collections::HashMap::new(); props.insert("berries".to_string(),
                "false".to_string()); props.insert("age".to_string(), "0".to_string());
                BlockStateCodec { name : & pumpkin_data::Block::CAVE_VINES, properties :
                Some(props), } .get_state() }, weight : 4i32 }, Weighted { data : { let
                mut props = std::collections::HashMap::new(); props.insert("berries"
                .to_string(), "true".to_string()); props.insert("age".to_string(), "0"
                .to_string()); BlockStateCodec { name : &
                pumpkin_data::Block::CAVE_VINES, properties : Some(props), } .get_state()
                }, weight : 1i32 }], })), property : "age".to_string(), values :
                IntProvider::Object(NormalIntProvider::Uniform(UniformIntProvider {
                min_inclusive : 23i32, max_inclusive : 25i32 })), }) }
            ],
    ...
    map.insert(
        ...
        ConfiguredFeature::BlockColumn(BlockColumnFeature {
            layers: vec![
                ...
                { distribution : vec![WeightedEntry { data :
                IntProvider::Object(NormalIntProvider::Uniform(UniformIntProvider {
                min_inclusive : 0i32, max_inclusive : 3i32 })), weight : 5i32 },
                WeightedEntry { data :
                IntProvider::Object(NormalIntProvider::Uniform(UniformIntProvider {
                min_inclusive : 1i32, max_inclusive : 7i32 })), weight : 1i32 }] })),
                provider : BlockStateProvider::Weighted(WeightedBlockStateProvider {
                entries : vec![Weighted { data : { let mut props =
                std::collections::HashMap::new(); props.insert("berries".to_string(),
                "false".to_string()); BlockStateCodec { name : &
            ...
            Box::new(TreeFeature {
                ...
                trunk_placer: TrunkPlacer {
                    ...
                    r#type: TrunkType::Cherry(CherryTrunkPlacer {
                        branch_count: IntProvider::Object(
                            NormalIntProvider::WeightedList(WeightedListIntProvider {
                                distribution: vec![
                                    WeightedEntry { data : IntProvider::Constant(1i32), weight :
                                    1i32 }, WeightedEntry { data : IntProvider::Constant(2i32),
                                    weight : 1i32 }, WeightedEntry { data :
                                    IntProvider::Constant(3i32), weight : 1i32 }
                                ],
                            }),
                        ),
                        branch_horizontal_length: IntProvider::Object(
                            NormalIntProvider::Uniform(UniformIntProvider {
                                min_inclusive: 2i32,
                                max_inclusive: 4i32,
                            }),
                        ...
                        branch_end_offset_from_top: IntProvider::Object(
                            NormalIntProvider::Uniform(UniformIntProvider {
                                min_inclusive: -1i32,
                                max_inclusive: 0i32,
                            }),
    ...
    map.insert(
        ...
        ConfiguredFeature::ChorusPlant(crate::generation::feature::features::chorus_plant::ChorusPlantFeature {}),
    );
    map.insert(
    ...
    map.insert(
        ...
        ConfiguredFeature::NetherForestVegetation(NetherForestVegetationFeature {
            state_provider: BlockStateProvider::Weighted(WeightedBlockStateProvider {
                entries: vec![
                    Weighted { data : pumpkin_data::Block::CRIMSON_ROOTS.default_state,
                    weight : 87i32 }, Weighted { data :
                    pumpkin_data::Block::CRIMSON_FUNGUS.default_state, weight : 11i32 },
                    Weighted { data : pumpkin_data::Block::WARPED_FUNGUS.default_state,
                    weight : 1i32 }
                ],
            }),
            spread_width: 8i32,
    ...
    map.insert(
        ...
        ConfiguredFeature::RandomSelector(RandomFeature {
            features: vec![
                RandomFeatureEntry { feature : PlacedFeatureWrapper::Direct(PlacedFeature
                { feature :
                Feature::Named(pumpkin_data::configured_feature::ConfiguredFeature::HugeBrownMushroom),
                placement : vec![], }), chance : 0.025f32 }, RandomFeatureEntry { feature
                : PlacedFeatureWrapper::Direct(PlacedFeature { feature :
                Feature::Named(pumpkin_data::configured_feature::ConfiguredFeature::HugeRedMushroom),
                placement : vec![], }), chance : 0.05f32 }, RandomFeatureEntry { feature
                :
                PlacedFeatureWrapper::Named(pumpkin_data::placed_feature::PlacedFeature::DarkOakLeafLitter),
                chance : 0.6666667f32 }, RandomFeatureEntry { feature :
                PlacedFeatureWrapper::Named(pumpkin_data::placed_feature::PlacedFeature::FallenBirchTree),
                chance : 0.0025f32 }, RandomFeatureEntry { feature :
                PlacedFeatureWrapper::Named(pumpkin_data::placed_feature::PlacedFeature::BirchLeafLitter),
                chance : 0.2f32 }, RandomFeatureEntry { feature :
                PlacedFeatureWrapper::Named(pumpkin_data::placed_feature::PlacedFeature::FallenOakTree),
                chance : 0.0125f32 }, RandomFeatureEntry { feature :
                PlacedFeatureWrapper::Named(pumpkin_data::placed_feature::PlacedFeature::FancyOakLeafLitter),
                chance : 0.1f32 }
            ],
            default: Box::new(
                PlacedFeatureWrapper::Named(
    ...
    map.insert(
        ...
        ConfiguredFeature::Disk(crate::generation::feature::features::disk::DiskFeature {
            ...
            target: BlockPredicate::MatchingBlocks(MatchingBlocksBlockPredicate {
                ...
                blocks: MatchingBlocksWrapper::Multiple(
                    vec!["minecraft:dirt".to_string(), "minecraft:clay".to_string()],
                ),
            }),
            radius: IntProvider::Object(
                NormalIntProvider::Uniform(UniformIntProvider {
        ...
        ConfiguredFeature::Disk(crate::generation::feature::features::disk::DiskFeature {
            state_provider: BlockStateProvider::Rule(RuleBasedBlockStateProvider {
                ...
                rules: vec![
                    ...
                    predicates : vec![BlockPredicate::Solid(SolidBlockPredicate { offset
                    ...
                    : OffsetBlocksBlockPredicate { offset : Some(Vector3::new(0i32, 1i32,
                    0i32)) }, fluids : MatchingBlocksWrapper::Single("minecraft:water"
                    .to_string()), })], })), }), then :
                    BlockStateProvider::Simple(SimpleStateProvider { state : { let mut
                    props = std::collections::HashMap::new(); props.insert("snowy"
                    .to_string(), "false".to_string()); BlockStateCodec { name : &
                    pumpkin_data::Block::GRASS_BLOCK, properties : Some(props), }
                    .get_state() } }) }
                ],
            }),
            target: BlockPredicate::MatchingBlocks(MatchingBlocksBlockPredicate {
                ...
                blocks: MatchingBlocksWrapper::Multiple(
                    vec!["minecraft:dirt".to_string(), "minecraft:mud".to_string()],
                ),
            }),
            radius: IntProvider::Object(
                NormalIntProvider::Uniform(UniformIntProvider {
    ...
    map.insert(
        ...
        ConfiguredFeature::Disk(crate::generation::feature::features::disk::DiskFeature {
            ...
            target: BlockPredicate::MatchingBlocks(MatchingBlocksBlockPredicate {
                ...
                blocks: MatchingBlocksWrapper::Multiple(
                    vec![
                        "minecraft:dirt".to_string(), "minecraft:grass_block".to_string()
                    ],
                ),
            }),
            radius: IntProvider::Object(
    ...
    map.insert(
        ...
        ConfiguredFeature::Disk(crate::generation::feature::features::disk::DiskFeature {
            state_provider: BlockStateProvider::Rule(RuleBasedBlockStateProvider {
                ...
                rules: vec![
                    BlockStateRule { if_true :
                    BlockPredicate::MatchingBlocks(MatchingBlocksBlockPredicate { offset
                    : OffsetBlocksBlockPredicate { offset : Some(Vector3::new(0i32, -
                    1i32, 0i32)) }, blocks :
                    MatchingBlocksWrapper::Single("minecraft:air".to_string()), }), then
                    : BlockStateProvider::Simple(SimpleStateProvider { state :
                    pumpkin_data::Block::SANDSTONE.default_state }) }
                ],
            }),
            target: BlockPredicate::MatchingBlocks(MatchingBlocksBlockPredicate {
                offset: OffsetBlocksBlockPredicate {
    ...
    map.insert(
        ...
        ConfiguredFeature::SimpleRandomSelector(SimpleRandomFeature {
            features: vec![
                ...
                Feature::Inlined(Box::new(ConfiguredFeature::SimpleBlock(SimpleBlockFeature
                { to_place : BlockStateProvider::Weighted(WeightedBlockStateProvider {
                entries : vec![Weighted { data : { let mut props =
                std::collections::HashMap::new(); props.insert("waterlogged".to_string(),
                "false".to_string()); props.insert("half".to_string(), "lower"
                .to_string()); props.insert("facing".to_string(), "east".to_string());
                BlockStateCodec { name : & pumpkin_data::Block::SMALL_DRIPLEAF,
                properties : Some(props), } .get_state() }, weight : 1i32 }, Weighted {
                data : { let mut props = std::collections::HashMap::new(); props
                .insert("waterlogged".to_string(), "false".to_string()); props
                .insert("half".to_string(), "lower".to_string()); props.insert("facing"
                .to_string(), "west".to_string()); BlockStateCodec { name : &
                pumpkin_data::Block::SMALL_DRIPLEAF, properties : Some(props), }
                .get_state() }, weight : 1i32 }, Weighted { data : { let mut props =
                std::collections::HashMap::new(); props.insert("waterlogged".to_string(),
                "false".to_string()); props.insert("half".to_string(), "lower"
                .to_string()); props.insert("facing".to_string(), "north".to_string());
                BlockStateCodec { name : & pumpkin_data::Block::SMALL_DRIPLEAF,
                properties : Some(props), } .get_state() }, weight : 1i32 }, Weighted {
                data : { let mut props = std::collections::HashMap::new(); props
                .insert("waterlogged".to_string(), "false".to_string()); props
                .insert("half".to_string(), "lower".to_string()); props.insert("facing"
                .to_string(), "south".to_string()); BlockStateCodec { name : &
                pumpkin_data::Block::SMALL_DRIPLEAF, properties : Some(props), }
                .get_state() }, weight : 1i32 }], }), schedule_tick : None, }))),
                placement : vec![], }, PlacedFeature { feature :
                Feature::Inlined(Box::new(ConfiguredFeature::BlockColumn(BlockColumnFeature
                { layers : vec![Layer { height :
                IntProvider::Object(NormalIntProvider::WeightedList(WeightedListIntProvider
                { distribution : vec![WeightedEntry { data :
                IntProvider::Object(NormalIntProvider::Uniform(UniformIntProvider {
                min_inclusive : 0i32, max_inclusive : 4i32 })), weight : 2i32 },
                WeightedEntry { data : IntProvider::Constant(0i32), weight : 1i32 }] })),
                provider : BlockStateProvider::Simple(SimpleStateProvider { state : { let
                mut props = std::collections::HashMap::new(); props.insert("waterlogged"
                .to_string(), "false".to_string()); props.insert("facing".to_string(),
                "east".to_string()); BlockStateCodec { name : &
                pumpkin_data::Block::BIG_DRIPLEAF_STEM, properties : Some(props), }
                .get_state() } }) }, Layer { height : IntProvider::Constant(1i32),
                provider : BlockStateProvider::Simple(SimpleStateProvider { state : { let
                mut props = std::collections::HashMap::new(); props.insert("waterlogged"
                .to_string(), "false".to_string()); props.insert("tilt".to_string(),
                "none".to_string()); props.insert("facing".to_string(), "east"
                .to_string()); BlockStateCodec { name : &
                pumpkin_data::Block::BIG_DRIPLEAF, properties : Some(props), }
                .get_state() } }) }], direction : BlockDirection::Up, allowed_placement :
                ...
                pumpkin_data::tag::Block::MINECRAFT_AIR, }),
                BlockPredicate::MatchingBlocks(MatchingBlocksBlockPredicate { offset :
                OffsetBlocksBlockPredicate { offset : None }, blocks :
                MatchingBlocksWrapper::Single("minecraft:water".to_string()), })], }),
                prioritize_tip : true, }))), placement : vec![], }, PlacedFeature {
                feature :
                Feature::Inlined(Box::new(ConfiguredFeature::BlockColumn(BlockColumnFeature
                { layers : vec![Layer { height :
                IntProvider::Object(NormalIntProvider::WeightedList(WeightedListIntProvider
                ...
                mut props = std::collections::HashMap::new(); props.insert("waterlogged"
                .to_string(), "false".to_string()); props.insert("tilt".to_string(),
                "none".to_string()); props.insert("facing".to_string(), "west"
                .to_string()); BlockStateCodec { name : &
                pumpkin_data::Block::BIG_DRIPLEAF, properties : Some(props), }
                .get_state() } }) }], direction : BlockDirection::Up, allowed_placement :
                BlockPredicate::AnyOf(AnyOfBlockPredicate { predicates :
                ...
                mut props = std::collections::HashMap::new(); props.insert("waterlogged"
                .to_string(), "false".to_string()); props.insert("tilt".to_string(),
                "none".to_string()); props.insert("facing".to_string(), "south"
                .to_string()); BlockStateCodec { name : &
                pumpkin_data::Block::BIG_DRIPLEAF, properties : Some(props), }
                .get_state() } }) }], direction : BlockDirection::Up, allowed_placement :
                BlockPredicate::AnyOf(AnyOfBlockPredicate { predicates :
                ...
                mut props = std::collections::HashMap::new(); props.insert("waterlogged"
                .to_string(), "false".to_string()); props.insert("tilt".to_string(),
                "none".to_string()); props.insert("facing".to_string(), "north"
                .to_string()); BlockStateCodec { name : &
                pumpkin_data::Block::BIG_DRIPLEAF, properties : Some(props), }
                .get_state() } }) }], direction : BlockDirection::Up, allowed_placement :
                BlockPredicate::AnyOf(AnyOfBlockPredicate { predicates :
                ...
                OffsetBlocksBlockPredicate { offset : None }, blocks :
                MatchingBlocksWrapper::Single("minecraft:water".to_string()), })], }),
                prioritize_tip : true, }))), placement : vec![], }
            ],
        }),
    );
    map.insert(
        pumpkin_data::configured_feature::ConfiguredFeature::DripstoneCluster,
        ConfiguredFeature::DripstoneCluster(crate::generation::feature::features::drip_stone::cluster::DripstoneClusterFeature {}),
    );
    map.insert(
        ...
        ConfiguredFeature::SimpleBlock(SimpleBlockFeature {
            to_place: BlockStateProvider::Weighted(WeightedBlockStateProvider {
                entries: vec![
                    Weighted { data : pumpkin_data::Block::SHORT_DRY_GRASS.default_state,
                    weight : 1i32 }, Weighted { data :
                    pumpkin_data::Block::TALL_DRY_GRASS.default_state, weight : 1i32 }
                ],
            }),
            schedule_tick: None,
        }),
    ...
    map.insert(
        ...
        ConfiguredFeature::EndIsland(crate::generation::feature::features::end_island::EndIslandFeature {}),
    );
    map.insert(
        ...
        ConfiguredFeature::Tree(
            Box::new(TreeFeature {
                ...
                foliage_placer: FoliagePlacer {
                    ...
                    r#type: FoliageType::Fancy(LargeOakFoliagePlacer {
                        height: 4i32,
                    }),
                },
                minimum_size: FeatureSize {
    ...
    map.insert(
        ...
        ConfiguredFeature::Tree(
            Box::new(TreeFeature {
                ...
                decorators: vec![
                    TreeDecorator::Beehive(BeehiveTreeDecorator { probability : 1f32 })
                ],
                root_placer: None,
            }),
        ),
    ...
    map.insert(
        ...
        ConfiguredFeature::SimpleBlock(SimpleBlockFeature {
            to_place: BlockStateProvider::Weighted(WeightedBlockStateProvider {
                entries: vec![
                    Weighted { data : { let mut props = std::collections::HashMap::new();
                    props.insert("flower_amount".to_string(), "1".to_string()); props
                    .insert("facing".to_string(), "north".to_string()); BlockStateCodec {
                    name : & pumpkin_data::Block::PINK_PETALS, properties : Some(props),
                    } .get_state() }, weight : 1i32 }, Weighted { data : { let mut props
                    = std::collections::HashMap::new(); props.insert("flower_amount"
                    .to_string(), "1".to_string()); props.insert("facing".to_string(),
                    "east".to_string()); BlockStateCodec { name : &
                    pumpkin_data::Block::PINK_PETALS, properties : Some(props), }
                    .get_state() }, weight : 1i32 }, Weighted { data : { let mut props =
                    std::collections::HashMap::new(); props.insert("flower_amount"
                    .to_string(), "1".to_string()); props.insert("facing".to_string(),
                    "south".to_string()); BlockStateCodec { name : &
    ...
    map.insert(
        ...
        ConfiguredFeature::SimpleBlock(SimpleBlockFeature {
            to_place: BlockStateProvider::Weighted(WeightedBlockStateProvider {
                entries: vec![
                    Weighted { data : pumpkin_data::Block::POPPY.default_state, weight :
                    2i32 }, Weighted { data : pumpkin_data::Block::DANDELION
                    .default_state, weight : 1i32 }
                ],
            }),
            schedule_tick: None,
        }),
        ...
        ConfiguredFeature::SimpleBlock(SimpleBlockFeature {
            to_place: BlockStateProvider::NoiseProvider(NoiseBlockStateProvider {
                ...
                states: vec![
                    ...
                    pumpkin_data::Block::POPPY.default_state, pumpkin_data::Block::ALLIUM
                    .default_state, pumpkin_data::Block::AZURE_BLUET.default_state,
        ...
        ConfiguredFeature::SimpleBlock(SimpleBlockFeature {
            to_place: BlockStateProvider::DualNoise(DualNoiseBlockStateProvider {
                base: NoiseBlockStateProvider {
                    ...
                    states: vec![
                        { let mut props = std::collections::HashMap::new(); props
                        .insert("half".to_string(), "lower".to_string()); BlockStateCodec
                        { name : & pumpkin_data::Block::TALL_GRASS, properties :
                        Some(props), } .get_state() }, pumpkin_data::Block::ALLIUM
                        .default_state, pumpkin_data::Block::POPPY.default_state,
    ...
    map.insert(
        ...
        ConfiguredFeature::SimpleRandomSelector(SimpleRandomFeature {
            features: vec![
                ...
                let mut props = std::collections::HashMap::new(); props.insert("half"
                .to_string(), "lower".to_string()); BlockStateCodec { name : &
                pumpkin_data::Block::LILAC, properties : Some(props), } .get_state() }
                }), schedule_tick : None, }))), placement :
                vec![PlacementModifier::Count(CountPlacementModifier { count :
                ...
                offset : OffsetBlocksBlockPredicate { offset : None }, tag :
                pumpkin_data::tag::Block::MINECRAFT_AIR, }) })], }, PlacedFeature {
                feature :
                Feature::Inlined(Box::new(ConfiguredFeature::SimpleBlock(SimpleBlockFeature
                { to_place : BlockStateProvider::Simple(SimpleStateProvider { state : {
                let mut props = std::collections::HashMap::new(); props.insert("half"
                .to_string(), "lower".to_string()); BlockStateCodec { name : &
                pumpkin_data::Block::ROSE_BUSH, properties : Some(props), } .get_state()
                } }), schedule_tick : None, }))), placement :
                vec![PlacementModifier::Count(CountPlacementModifier { count :
                IntProvider::Constant(96i32) }),
                PlacementModifier::RandomOffset(RandomOffsetPlacementModifier { xz_spread
                ...
                let mut props = std::collections::HashMap::new(); props.insert("half"
                .to_string(), "lower".to_string()); BlockStateCodec { name : &
                pumpkin_data::Block::PEONY, properties : Some(props), } .get_state() }
                }), schedule_tick : None, }))), placement :
                vec![PlacementModifier::Count(CountPlacementModifier { count :
                IntProvider::Constant(96i32) }),
                PlacementModifier::RandomOffset(RandomOffsetPlacementModifier { xz_spread
                ...
                Feature::Inlined(Box::new(ConfiguredFeature::SimpleBlock(SimpleBlockFeature
                { to_place : BlockStateProvider::Simple(SimpleStateProvider { state :
                pumpkin_data::Block::LILY_OF_THE_VALLEY.default_state }), schedule_tick :
                None, }))), placement :
                vec![PlacementModifier::Count(CountPlacementModifier { count :
                IntProvider::Constant(96i32) }),
                PlacementModifier::RandomOffset(RandomOffsetPlacementModifier { xz_spread
    ...
    map.insert(
        ...
        ConfiguredFeature::FreezeTopLayer(crate::generation::feature::features::freeze_top_layer::FreezeTopLayerFeature {}),
    );
    map.insert(
    ...
    map.insert(
        ...
        ConfiguredFeature::GlowstoneBlob(crate::generation::feature::features::glowstone_blob::GlowstoneBlobFeature {}),
    );
    map.insert(
    ...
    map.insert(
        ...
        ConfiguredFeature::SimpleBlock(SimpleBlockFeature {
            to_place: BlockStateProvider::Weighted(WeightedBlockStateProvider {
                entries: vec![
                    Weighted { data : pumpkin_data::Block::SHORT_GRASS.default_state,
                    weight : 3i32 }, Weighted { data : pumpkin_data::Block::FERN
                    .default_state, weight : 1i32 }
                ],
            }),
            schedule_tick: None,
    ...
    map.insert(
        ...
        ConfiguredFeature::HugeBrownMushroom(crate::generation::feature::features::huge_brown_mushroom::HugeBrownMushroomFeature {}),
    );
    map.insert(
        pumpkin_data::configured_feature::ConfiguredFeature::HugeRedMushroom,
        ConfiguredFeature::HugeRedMushroom(crate::generation::feature::features::huge_red_mushroom::HugeRedMushroomFeature {}),
    );
    map.insert(
        ...
        ConfiguredFeature::Disk(crate::generation::feature::features::disk::DiskFeature {
            ...
            target: BlockPredicate::MatchingBlocks(MatchingBlocksBlockPredicate {
                ...
                blocks: MatchingBlocksWrapper::Multiple(
                    vec![
                        "minecraft:dirt".to_string(), "minecraft:grass_block"
                        .to_string(), "minecraft:podzol".to_string(),
                        "minecraft:coarse_dirt".to_string(), "minecraft:mycelium"
                        .to_string(), "minecraft:snow_block".to_string(), "minecraft:ice"
                        .to_string()
                    ],
                ),
            }),
    ...
    map.insert(
        ...
        ConfiguredFeature::IceSpike(crate::generation::feature::features::ice_spike::IceSpikeFeature {}),
    );
    map.insert(
        pumpkin_data::configured_feature::ConfiguredFeature::IcebergBlue,
        ConfiguredFeature::Iceberg(crate::generation::feature::features::iceberg::IcebergFeature {
        ...
        ConfiguredFeature::Tree(
            Box::new(TreeFeature {
                ...
                decorators: vec![
                    ...
                    TreeDecorator::LeaveVine(LeavesVineTreeDecorator { probability :
                    0.25f32 })
                ],
                root_placer: None,
            }),
    ...
    map.insert(
        ...
        ConfiguredFeature::BasaltColumns(crate::generation::feature::features::basalt_columns::BasaltColumnsFeature {
            height: IntProvider::Object(
                NormalIntProvider::Uniform(UniformIntProvider {
                    min_inclusive: 5i32,
                    max_inclusive: 10i32,
                }),
            ),
            reach: IntProvider::Object(
                NormalIntProvider::Uniform(UniformIntProvider {
                    min_inclusive: 2i32,
                    max_inclusive: 3i32,
                }),
    ...
    map.insert(
        ...
        ConfiguredFeature::LargeDripstone(crate::generation::feature::features::drip_stone::large::LargeDripstoneFeature {}),
    );
    map.insert(
    ...
    map.insert(
        ...
        ConfiguredFeature::SimpleBlock(SimpleBlockFeature {
            to_place: BlockStateProvider::Weighted(WeightedBlockStateProvider {
                entries: vec![
                    Weighted { data : { let mut props = std::collections::HashMap::new();
                    props.insert("segment_amount".to_string(), "1".to_string()); props
                    .insert("facing".to_string(), "north".to_string()); BlockStateCodec {
                    name : & pumpkin_data::Block::LEAF_LITTER, properties : Some(props),
                    } .get_state() }, weight : 1i32 }, Weighted { data : { let mut props
                    = std::collections::HashMap::new(); props.insert("segment_amount"
                    .to_string(), "1".to_string()); props.insert("facing".to_string(),
                    "east".to_string()); BlockStateCodec { name : &
            ...
            Box::new(TreeFeature {
                ...
                trunk_placer: TrunkPlacer {
                    ...
                    r#type: TrunkType::UpwardsBranching(UpwardsBranchingTrunkPlacer {
                        extra_branch_steps: IntProvider::Object(
                            NormalIntProvider::Uniform(UniformIntProvider {
                                min_inclusive: 1i32,
                                max_inclusive: 4i32,
                            }),
                        ...
                        extra_branch_length: IntProvider::Object(
                            NormalIntProvider::Uniform(UniformIntProvider {
                                min_inclusive: 0i32,
                                max_inclusive: 1i32,
                            }),
                        ),
                        can_grow_through: &pumpkin_data::tag::Block::MINECRAFT_MANGROVE_LOGS_CAN_GROW_THROUGH
                            .1,
                    }),
                },
                foliage_provider: BlockStateProvider::Simple(SimpleStateProvider {
                ...
                root_placer: Some(
                    RootPlacer::Mangrove(MangroveRootPlacer {
                        trunk_offset_y: IntProvider::Object(
                            NormalIntProvider::Uniform(UniformIntProvider {
                                min_inclusive: 1i32,
                                max_inclusive: 3i32,
                            }),
                        ...
                        root_provider: BlockStateProvider::Simple(SimpleStateProvider {
                            state: {
                                let mut props = std::collections::HashMap::new();
                                props
                                    .insert("waterlogged".to_string(), "false".to_string());
                                BlockStateCodec {
                        ...
                        mangrove_root_placement: MangroveRootPlacement {
                            can_grow_through: &pumpkin_data::tag::Block::MINECRAFT_MANGROVE_ROOTS_CAN_GROW_THROUGH
                                .1,
                            muddy_roots_in: &[
                                pumpkin_data::Block::MUD.id,
                                pumpkin_data::Block::MUDDY_MANGROVE_ROOTS.id,
                            ],
    ...
    map.insert(
        ...
        ConfiguredFeature::RandomSelector(RandomFeature {
            features: vec![
                RandomFeatureEntry { feature :
                PlacedFeatureWrapper::Named(pumpkin_data::placed_feature::PlacedFeature::TallMangroveChecked),
                chance : 0.85f32 }
            ],
            default: Box::new(
                PlacedFeatureWrapper::Named(
    ...
    map.insert(
        ...
        ConfiguredFeature::RandomSelector(RandomFeature {
            features: vec![
                RandomFeatureEntry { feature :
                PlacedFeatureWrapper::Named(pumpkin_data::placed_feature::PlacedFeature::FancyOakBees),
                chance : 0.5f32 }
            ],
            default: Box::new(
                PlacedFeatureWrapper::Named(
        ...
        ConfiguredFeature::Tree(
            Box::new(TreeFeature {
                ...
                foliage_placer: FoliagePlacer {
                    radius: IntProvider::Constant(2i32),
                    offset: IntProvider::Constant(0i32),
                    r#type: FoliageType::Jungle(JungleFoliagePlacer {
                        height: 2i32,
                    }),
                },
                minimum_size: FeatureSize {
            ...
            Box::new(TreeFeature {
                ...
                foliage_placer: FoliagePlacer {
                    ...
                    r#type: FoliageType::MegaPine(MegaPineFoliagePlacer {
                        crown_height: IntProvider::Object(
                            NormalIntProvider::Uniform(UniformIntProvider {
                                min_inclusive: 3i32,
                                max_inclusive: 7i32,
                            }),
                ...
                decorators: vec![
                    TreeDecorator::AlterGround(AlterGroundTreeDecorator {})
                ],
                root_placer: None,
            }),
        ),
    ...
    map.insert(
        ...
        ConfiguredFeature::MonsterRoom(crate::generation::feature::features::monster_room::DungeonFeature {}),
    );
    map.insert(
    ...
    map.insert(
        ...
        ConfiguredFeature::SimpleBlock(SimpleBlockFeature {
            to_place: BlockStateProvider::Weighted(WeightedBlockStateProvider {
                entries: vec![
                    Weighted { data : pumpkin_data::Block::FLOWERING_AZALEA
                    .default_state, weight : 4i32 }, Weighted { data :
                    pumpkin_data::Block::AZALEA.default_state, weight : 7i32 }, Weighted
                    { data : pumpkin_data::Block::MOSS_CARPET.default_state, weight :
                    25i32 }, Weighted { data : pumpkin_data::Block::SHORT_GRASS
                    .default_state, weight : 50i32 }, Weighted { data : { let mut props =
                    std::collections::HashMap::new(); props.insert("half".to_string(),
                    "lower".to_string()); BlockStateCodec { name : &
                    pumpkin_data::Block::TALL_GRASS, properties : Some(props), }
                    .get_state() }, weight : 10i32 }
                ],
            }),
            schedule_tick: None,
        }),
    ...
    map.insert(
        ...
        ConfiguredFeature::ScatteredOre(crate::generation::feature::features::scattered_ore::ScatteredOreFeature {
            ...
            targets: vec![
                OreTarget { target : RuleTest::TagMatch(TagMatchRuleTest { tag :
                pumpkin_data::tag::Block::MINECRAFT_BASE_STONE_NETHER }), state :
                pumpkin_data::Block::ANCIENT_DEBRIS.default_state }
            ],
        }),
    );
    map.insert(
    ...
    map.insert(
        ...
        ConfiguredFeature::Ore(OreFeature {
            ...
            targets: vec![
                OreTarget { target : RuleTest::TagMatch(TagMatchRuleTest { tag :
                pumpkin_data::tag::Block::MINECRAFT_BASE_STONE_OVERWORLD }), state :
                pumpkin_data::Block::ANDESITE.default_state }
            ],
        }),
    );
    map.insert(
        ...
        ConfiguredFeature::Ore(OreFeature {
            ...
            discard_chance_on_air_exposure: 0f32,
            targets: vec![
                OreTarget { target : RuleTest::BlockMatch(BlockMatchRuleTest { block :
                pumpkin_data::Block::NETHERRACK }), state :
                pumpkin_data::Block::BLACKSTONE.default_state }
            ],
        }),
    );
    map.insert(
        ...
        ConfiguredFeature::Ore(OreFeature {
            ...
            targets: vec![
                OreTarget { target : RuleTest::TagMatch(TagMatchRuleTest { tag :
                pumpkin_data::tag::Block::MINECRAFT_BASE_STONE_OVERWORLD }), state :
                pumpkin_data::Block::CLAY.default_state }
            ],
        }),
    );
    map.insert(
        ...
        ConfiguredFeature::Ore(OreFeature {
            ...
            targets: vec![
                OreTarget { target : RuleTest::TagMatch(TagMatchRuleTest { tag :
                pumpkin_data::tag::Block::MINECRAFT_STONE_ORE_REPLACEABLES }), state :
                pumpkin_data::Block::COAL_ORE.default_state }, OreTarget { target :
                RuleTest::TagMatch(TagMatchRuleTest { tag :
                pumpkin_data::tag::Block::MINECRAFT_DEEPSLATE_ORE_REPLACEABLES }), state
                : pumpkin_data::Block::DEEPSLATE_COAL_ORE.default_state }
            ],
        }),
    );
    map.insert(
    ...
    map.insert(
        ...
        ConfiguredFeature::Ore(OreFeature {
            ...
            targets: vec![
                OreTarget { target : RuleTest::TagMatch(TagMatchRuleTest { tag :
                pumpkin_data::tag::Block::MINECRAFT_STONE_ORE_REPLACEABLES }), state :
                pumpkin_data::Block::COPPER_ORE.default_state }, OreTarget { target :
                RuleTest::TagMatch(TagMatchRuleTest { tag :
                pumpkin_data::tag::Block::MINECRAFT_DEEPSLATE_ORE_REPLACEABLES }), state
                : pumpkin_data::Block::DEEPSLATE_COPPER_ORE.default_state }
            ],
        }),
    );
    map.insert(
    ...
    map.insert(
        ...
        ConfiguredFeature::Ore(OreFeature {
            ...
            targets: vec![
                OreTarget { target : RuleTest::TagMatch(TagMatchRuleTest { tag :
                pumpkin_data::tag::Block::MINECRAFT_STONE_ORE_REPLACEABLES }), state :
                pumpkin_data::Block::DIAMOND_ORE.default_state }, OreTarget { target :
                RuleTest::TagMatch(TagMatchRuleTest { tag :
                pumpkin_data::tag::Block::MINECRAFT_DEEPSLATE_ORE_REPLACEABLES }), state
                : pumpkin_data::Block::DEEPSLATE_DIAMOND_ORE.default_state }
            ],
        }),
    );
    map.insert(
    ...
    map.insert(
        ...
        ConfiguredFeature::Ore(OreFeature {
            ...
            targets: vec![
                OreTarget { target : RuleTest::TagMatch(TagMatchRuleTest { tag :
                pumpkin_data::tag::Block::MINECRAFT_BASE_STONE_OVERWORLD }), state :
                pumpkin_data::Block::DIORITE.default_state }
            ],
        }),
    );
    map.insert(
        ...
        ConfiguredFeature::Ore(OreFeature {
            ...
            targets: vec![
                OreTarget { target : RuleTest::TagMatch(TagMatchRuleTest { tag :
                pumpkin_data::tag::Block::MINECRAFT_BASE_STONE_OVERWORLD }), state :
                pumpkin_data::Block::DIRT.default_state }
            ],
        }),
    );
    map.insert(
        ...
        ConfiguredFeature::Ore(OreFeature {
            ...
            targets: vec![
                OreTarget { target : RuleTest::TagMatch(TagMatchRuleTest { tag :
                pumpkin_data::tag::Block::MINECRAFT_STONE_ORE_REPLACEABLES }), state :
                pumpkin_data::Block::EMERALD_ORE.default_state }, OreTarget { target :
                RuleTest::TagMatch(TagMatchRuleTest { tag :
                pumpkin_data::tag::Block::MINECRAFT_DEEPSLATE_ORE_REPLACEABLES }), state
                : pumpkin_data::Block::DEEPSLATE_EMERALD_ORE.default_state }
            ],
        }),
    );
    map.insert(
        ...
        ConfiguredFeature::Ore(OreFeature {
            ...
            targets: vec![
                OreTarget { target : RuleTest::TagMatch(TagMatchRuleTest { tag :
                pumpkin_data::tag::Block::MINECRAFT_STONE_ORE_REPLACEABLES }), state :
                pumpkin_data::Block::GOLD_ORE.default_state }, OreTarget { target :
                RuleTest::TagMatch(TagMatchRuleTest { tag :
                pumpkin_data::tag::Block::MINECRAFT_DEEPSLATE_ORE_REPLACEABLES }), state
                : pumpkin_data::Block::DEEPSLATE_GOLD_ORE.default_state }
            ],
        }),
    );
    map.insert(
    ...
    map.insert(
        ...
        ConfiguredFeature::Ore(OreFeature {
            ...
            targets: vec![
                OreTarget { target : RuleTest::TagMatch(TagMatchRuleTest { tag :
                pumpkin_data::tag::Block::MINECRAFT_BASE_STONE_OVERWORLD }), state :
                pumpkin_data::Block::GRANITE.default_state }
            ],
        }),
    );
    map.insert(
        ...
        ConfiguredFeature::Ore(OreFeature {
            ...
            targets: vec![
                OreTarget { target : RuleTest::TagMatch(TagMatchRuleTest { tag :
                pumpkin_data::tag::Block::MINECRAFT_BASE_STONE_OVERWORLD }), state :
                pumpkin_data::Block::GRAVEL.default_state }
            ],
        }),
    );
    map.insert(
        ...
        ConfiguredFeature::Ore(OreFeature {
            ...
            targets: vec![
                OreTarget { target : RuleTest::BlockMatch(BlockMatchRuleTest { block :
                pumpkin_data::Block::NETHERRACK }), state : pumpkin_data::Block::GRAVEL
                .default_state }
            ],
        }),
    );
    map.insert(
        ...
        ConfiguredFeature::Ore(OreFeature {
            ...
            targets: vec![
                OreTarget { target : RuleTest::TagMatch(TagMatchRuleTest { tag :
                pumpkin_data::tag::Block::MINECRAFT_STONE_ORE_REPLACEABLES }), state :
                pumpkin_data::Block::INFESTED_STONE.default_state }, OreTarget { target :
                RuleTest::TagMatch(TagMatchRuleTest { tag :
                pumpkin_data::tag::Block::MINECRAFT_DEEPSLATE_ORE_REPLACEABLES }), state
                : { let mut props = std::collections::HashMap::new(); props.insert("axis"
                .to_string(), "y".to_string()); BlockStateCodec { name : &
                pumpkin_data::Block::INFESTED_DEEPSLATE, properties : Some(props), }
                .get_state() } }
            ],
        }),
    );
    map.insert(
        ...
        ConfiguredFeature::Ore(OreFeature {
            ...
            targets: vec![
                OreTarget { target : RuleTest::TagMatch(TagMatchRuleTest { tag :
                pumpkin_data::tag::Block::MINECRAFT_STONE_ORE_REPLACEABLES }), state :
                pumpkin_data::Block::IRON_ORE.default_state }, OreTarget { target :
                RuleTest::TagMatch(TagMatchRuleTest { tag :
                pumpkin_data::tag::Block::MINECRAFT_DEEPSLATE_ORE_REPLACEABLES }), state
                : pumpkin_data::Block::DEEPSLATE_IRON_ORE.default_state }
            ],
        }),
    );
    map.insert(
    ...
    map.insert(
        ...
        ConfiguredFeature::Ore(OreFeature {
            ...
            targets: vec![
                OreTarget { target : RuleTest::TagMatch(TagMatchRuleTest { tag :
                pumpkin_data::tag::Block::MINECRAFT_STONE_ORE_REPLACEABLES }), state :
                pumpkin_data::Block::LAPIS_ORE.default_state }, OreTarget { target :
                RuleTest::TagMatch(TagMatchRuleTest { tag :
                pumpkin_data::tag::Block::MINECRAFT_DEEPSLATE_ORE_REPLACEABLES }), state
                : pumpkin_data::Block::DEEPSLATE_LAPIS_ORE.default_state }
            ],
        }),
    );
    map.insert(
    ...
    map.insert(
        ...
        ConfiguredFeature::Ore(OreFeature {
            ...
            targets: vec![
                OreTarget { target : RuleTest::BlockMatch(BlockMatchRuleTest { block :
                pumpkin_data::Block::NETHERRACK }), state :
                pumpkin_data::Block::MAGMA_BLOCK.default_state }
            ],
        }),
    );
    map.insert(
        ...
        ConfiguredFeature::Ore(OreFeature {
            ...
            targets: vec![
                OreTarget { target : RuleTest::BlockMatch(BlockMatchRuleTest { block :
                pumpkin_data::Block::NETHERRACK }), state :
                pumpkin_data::Block::NETHER_GOLD_ORE.default_state }
            ],
        }),
    );
    map.insert(
        ...
        ConfiguredFeature::Ore(OreFeature {
            ...
            targets: vec![
                OreTarget { target : RuleTest::BlockMatch(BlockMatchRuleTest { block :
                pumpkin_data::Block::NETHERRACK }), state :
                pumpkin_data::Block::NETHER_QUARTZ_ORE.default_state }
            ],
        }),
    );
    map.insert(
        ...
        ConfiguredFeature::Ore(OreFeature {
            ...
            targets: vec![
                OreTarget { target : RuleTest::TagMatch(TagMatchRuleTest { tag :
                pumpkin_data::tag::Block::MINECRAFT_STONE_ORE_REPLACEABLES }), state : {
                let mut props = std::collections::HashMap::new(); props.insert("lit"
                .to_string(), "false".to_string()); BlockStateCodec { name : &
                pumpkin_data::Block::REDSTONE_ORE, properties : Some(props), }
                .get_state() } }, OreTarget { target :
                RuleTest::TagMatch(TagMatchRuleTest { tag :
                pumpkin_data::tag::Block::MINECRAFT_DEEPSLATE_ORE_REPLACEABLES }), state
                : { let mut props = std::collections::HashMap::new(); props.insert("lit"
                .to_string(), "false".to_string()); BlockStateCodec { name : &
                pumpkin_data::Block::DEEPSLATE_REDSTONE_ORE, properties : Some(props), }
                .get_state() } }
            ],
        }),
    );
    map.insert(
        ...
        ConfiguredFeature::Ore(OreFeature {
            ...
            targets: vec![
                OreTarget { target : RuleTest::BlockMatch(BlockMatchRuleTest { block :
                pumpkin_data::Block::NETHERRACK }), state :
                pumpkin_data::Block::SOUL_SAND.default_state }
            ],
        }),
    );
    map.insert(
        ...
        ConfiguredFeature::Ore(OreFeature {
            ...
            targets: vec![
                OreTarget { target : RuleTest::TagMatch(TagMatchRuleTest { tag :
                pumpkin_data::tag::Block::MINECRAFT_BASE_STONE_OVERWORLD }), state :
                pumpkin_data::Block::TUFF.default_state }
            ],
        }),
    );
    map.insert(
    ...
    map.insert(
        ...
        ConfiguredFeature::RandomSelector(RandomFeature {
            features: vec![
                RandomFeatureEntry { feature :
                PlacedFeatureWrapper::Named(pumpkin_data::placed_feature::PlacedFeature::PaleOakCreakingChecked),
                chance : 0.1f32 }, RandomFeatureEntry { feature :
                PlacedFeatureWrapper::Named(pumpkin_data::placed_feature::PlacedFeature::PaleOakChecked),
                chance : 0.9f32 }
            ],
            default: Box::new(
                PlacedFeatureWrapper::Named(
    ...
    map.insert(
        ...
        ConfiguredFeature::SimpleBlock(SimpleBlockFeature {
            to_place: BlockStateProvider::Weighted(WeightedBlockStateProvider {
                entries: vec![
                    Weighted { data : { let mut props = std::collections::HashMap::new();
                    props.insert("west".to_string(), "none".to_string()); props
                    .insert("south".to_string(), "none".to_string()); props
                    .insert("north".to_string(), "none".to_string()); props.insert("east"
                    .to_string(), "none".to_string()); props.insert("bottom".to_string(),
                    "true".to_string()); BlockStateCodec { name : &
                    pumpkin_data::Block::PALE_MOSS_CARPET, properties : Some(props), }
                    .get_state() }, weight : 25i32 }, Weighted { data :
                    pumpkin_data::Block::SHORT_GRASS.default_state, weight : 25i32 },
                    Weighted { data : { let mut props = std::collections::HashMap::new();
                    props.insert("half".to_string(), "lower".to_string());
                    BlockStateCodec { name : & pumpkin_data::Block::TALL_GRASS,
                    properties : Some(props), } .get_state() }, weight : 10i32 }
                ],
            }),
            schedule_tick: None,
        }),
    ...
    map.insert(
        ...
        ConfiguredFeature::SimpleRandomSelector(SimpleRandomFeature {
            features: vec![
                PlacedFeature { feature :
                Feature::Inlined(Box::new(ConfiguredFeature::PointedDripstone(SmallDripstoneFeature
                { chance_of_taller_dripstone : 0.2f32, chance_of_directional_spread :
                0.7f32, chance_of_spread_radius2 : 0.5f32, chance_of_spread_radius3 :
                0.5f32, }))), placement :
                vec![PlacementModifier::EnvironmentScan(EnvironmentScanPlacementModifier
                ...
                : Some(BlockPredicate::AnyOf(AnyOfBlockPredicate { predicates :
                vec![BlockPredicate::MatchingBlockTag(MatchingBlockTagPredicate { offset
                : OffsetBlocksBlockPredicate { offset : None }, tag :
                pumpkin_data::tag::Block::MINECRAFT_AIR, }),
                BlockPredicate::MatchingBlocks(MatchingBlocksBlockPredicate { offset :
        ...
        ConfiguredFeature::RootSystem(crate::generation::feature::features::root_system::RootSystemFeature {
            ...
            allowed_tree_position: BlockPredicate::AllOf(AllOfBlockPredicate {
                predicates: vec![
                    ...
                    offset : OffsetBlocksBlockPredicate { offset : None }, tag :
                    pumpkin_data::tag::Block::MINECRAFT_AIR, }),
                    BlockPredicate::MatchingBlockTag(MatchingBlockTagPredicate { offset :
                    OffsetBlocksBlockPredicate { offset : None }, tag :
                    pumpkin_data::tag::Block::MINECRAFT_REPLACEABLE_BY_TREES, })], }),
                    BlockPredicate::MatchingBlockTag(MatchingBlockTagPredicate { offset :
                    OffsetBlocksBlockPredicate { offset : Some(Vector3::new(0i32, - 1i32,
                    0i32)) }, tag : pumpkin_data::tag::Block::MINECRAFT_AZALEA_GROWS_ON,
                    })
                ],
            }),
        }),
    ...
    map.insert(
        ...
        ConfiguredFeature::SculkPatch(crate::generation::feature::features::sculk_patch::SculkPatchFeature {
            ...
            growth_rounds: 0i32,
            spread_rounds: 1i32,
            extra_rare_growths: IntProvider::Object(
                NormalIntProvider::Uniform(UniformIntProvider {
                    min_inclusive: 1i32,
                    max_inclusive: 3i32,
                }),
    ...
    map.insert(
        ...
        ConfiguredFeature::SpringFeature(SpringFeatureFeature {
            ...
            rock_count: 4i32,
            hole_count: 1i32,
            valid_blocks: BlockWrapper::Multi(
                vec![
                    "minecraft:snow_block".to_string(), "minecraft:powder_snow"
                    .to_string(), "minecraft:packed_ice".to_string()
                ],
            ),
        }),
    );
    map.insert(
        ...
        ConfiguredFeature::SpringFeature(SpringFeatureFeature {
            ...
            valid_blocks: BlockWrapper::Multi(
                vec![
                    "minecraft:netherrack".to_string(), "minecraft:soul_sand"
                    .to_string(), "minecraft:gravel".to_string(), "minecraft:magma_block"
                    .to_string(), "minecraft:blackstone".to_string()
                ],
            ),
        }),
    );
    map.insert(
        ...
        ConfiguredFeature::SpringFeature(SpringFeatureFeature {
            ...
            valid_blocks: BlockWrapper::Multi(
                vec![
                    "minecraft:stone".to_string(), "minecraft:granite".to_string(),
                    "minecraft:diorite".to_string(), "minecraft:andesite".to_string(),
                    "minecraft:deepslate".to_string(), "minecraft:tuff".to_string(),
                    "minecraft:calcite".to_string(), "minecraft:dirt".to_string()
                ],
            ),
        }),
    );
            ...
            Box::new(TreeFeature {
                ...
                foliage_placer: FoliagePlacer {
                    ...
                    r#type: FoliageType::Spruce(SpruceFoliagePlacer {
                        trunk_height: IntProvider::Object(
                            NormalIntProvider::Uniform(UniformIntProvider {
                                min_inclusive: 1i32,
                                max_inclusive: 2i32,
                            }),
    ...
    map.insert(
        ...
        ConfiguredFeature::BlockColumn(BlockColumnFeature {
            layers: vec![
                Layer { height :
                IntProvider::Object(NormalIntProvider::BiasedToBottom(BiasedToBottomIntProvider
                { min_inclusive : 2i32, max_inclusive : 4i32 })), provider :
                BlockStateProvider::Simple(SimpleStateProvider { state : { let mut props
                = std::collections::HashMap::new(); props.insert("age".to_string(), "0"
                .to_string()); BlockStateCodec { name : &
                pumpkin_data::Block::SUGAR_CANE, properties : Some(props), } .get_state()
                } }) }
            ],
            direction: BlockDirection::Up,
            allowed_placement: BlockPredicate::MatchingBlockTag(MatchingBlockTagPredicate {
    ...
    map.insert(
        ...
        ConfiguredFeature::SimpleBlock(SimpleBlockFeature {
            to_place: BlockStateProvider::Weighted(WeightedBlockStateProvider {
                entries: vec![
                    Weighted { data : pumpkin_data::Block::SHORT_GRASS.default_state,
                    weight : 1i32 }, Weighted { data : pumpkin_data::Block::FERN
                    .default_state, weight : 4i32 }
                ],
            }),
            schedule_tick: None,
        }),
    ...
    map.insert(
        ...
        ConfiguredFeature::RandomSelector(RandomFeature {
            features: vec![
                ...
                PlacedFeatureWrapper::Named(pumpkin_data::placed_feature::PlacedFeature::FallenBirchTree),
                chance : 0.0025f32 }, RandomFeatureEntry { feature :
                PlacedFeatureWrapper::Named(pumpkin_data::placed_feature::PlacedFeature::BirchBees0002LeafLitter),
                chance : 0.2f32 }, RandomFeatureEntry { feature :
                PlacedFeatureWrapper::Named(pumpkin_data::placed_feature::PlacedFeature::FancyOakBees0002LeafLitter),
                chance : 0.1f32 }, RandomFeatureEntry { feature :
                PlacedFeatureWrapper::Named(pumpkin_data::placed_feature::PlacedFeature::FallenOakTree),
                chance : 0.0125f32 }
            ],
    ...
    map.insert(
        ...
        ConfiguredFeature::RandomSelector(RandomFeature {
            features: vec![
                ...
                PlacedFeatureWrapper::Named(pumpkin_data::placed_feature::PlacedFeature::FallenBirchTree),
                chance : 0.0025f32 }, RandomFeatureEntry { feature :
                PlacedFeatureWrapper::Named(pumpkin_data::placed_feature::PlacedFeature::BirchBees002),
                chance : 0.2f32 }, RandomFeatureEntry { feature :
                PlacedFeatureWrapper::Named(pumpkin_data::placed_feature::PlacedFeature::FancyOakBees002),
                chance : 0.1f32 }
            ],
            default: Box::new(
                PlacedFeatureWrapper::Named(
    ...
    map.insert(
        ...
        ConfiguredFeature::RandomSelector(RandomFeature {
            features: vec![
                RandomFeatureEntry { feature :
                PlacedFeatureWrapper::Named(pumpkin_data::placed_feature::PlacedFeature::PineOnSnow),
    ...
    map.insert(
        ...
        ConfiguredFeature::RandomSelector(RandomFeature {
            features: vec![
                ...
                chance : 0.5f32 }, RandomFeatureEntry { feature :
                PlacedFeatureWrapper::Named(pumpkin_data::placed_feature::PlacedFeature::MegaJungleTreeChecked),
                chance : 0.33333334f32 }, RandomFeatureEntry { feature :
                PlacedFeatureWrapper::Named(pumpkin_data::placed_feature::PlacedFeature::FallenJungleTree),
                chance : 0.0125f32 }
            ],
            default: Box::new(
                PlacedFeatureWrapper::Named(
    ...
    map.insert(
        ...
        ConfiguredFeature::RandomSelector(RandomFeature {
            features: vec![
                RandomFeatureEntry { feature :
                PlacedFeatureWrapper::Named(pumpkin_data::placed_feature::PlacedFeature::MegaSpruceChecked),
                chance : 0.025641026f32 }, RandomFeatureEntry { feature :
                PlacedFeatureWrapper::Named(pumpkin_data::placed_feature::PlacedFeature::MegaPineChecked),
                chance : 0.30769232f32 }, RandomFeatureEntry { feature :
                PlacedFeatureWrapper::Named(pumpkin_data::placed_feature::PlacedFeature::PineChecked),
                chance : 0.33333334f32 }, RandomFeatureEntry { feature :
                PlacedFeatureWrapper::Named(pumpkin_data::placed_feature::PlacedFeature::FallenSpruceTree),
                chance : 0.0125f32 }
            ],
            default: Box::new(
                PlacedFeatureWrapper::Named(
    ...
    map.insert(
        ...
        ConfiguredFeature::RandomSelector(RandomFeature {
            features: vec![
                RandomFeatureEntry { feature : PlacedFeatureWrapper::Direct(PlacedFeature
                { feature :
                Feature::Named(pumpkin_data::configured_feature::ConfiguredFeature::FancyOakBees005),
                placement : vec![], }), chance : 0.33333334f32 }, RandomFeatureEntry {
                feature :
                PlacedFeatureWrapper::Named(pumpkin_data::placed_feature::PlacedFeature::FallenOakTree),
                chance : 0.0125f32 }
            ],
    ...
    map.insert(
        ...
        ConfiguredFeature::RandomSelector(RandomFeature {
            features: vec![
                RandomFeatureEntry { feature :
                PlacedFeatureWrapper::Named(pumpkin_data::placed_feature::PlacedFeature::AcaciaChecked),
                chance : 0.8f32 }, RandomFeatureEntry { feature :
                PlacedFeatureWrapper::Named(pumpkin_data::placed_feature::PlacedFeature::FallenOakTree),
                chance : 0.0125f32 }
            ],
            default: Box::new(
    ...
    map.insert(
        ...
        ConfiguredFeature::RandomSelector(RandomFeature {
            features: vec![
                RandomFeatureEntry { feature :
                PlacedFeatureWrapper::Named(pumpkin_data::placed_feature::PlacedFeature::FallenSpruceTree),
                chance : 0.008325f32 }, RandomFeatureEntry { feature :
                PlacedFeatureWrapper::Named(pumpkin_data::placed_feature::PlacedFeature::SpruceChecked),
                chance : 0.666f32 }, RandomFeatureEntry { feature :
                PlacedFeatureWrapper::Named(pumpkin_data::placed_feature::PlacedFeature::FancyOakChecked),
                chance : 0.1f32 }, RandomFeatureEntry { feature :
                PlacedFeatureWrapper::Named(pumpkin_data::placed_feature::PlacedFeature::FallenOakTree),
                chance : 0.0125f32 }
    ...
    map.insert(
        ...
        ConfiguredFeature::UnderwaterMagma(crate::generation::feature::features::underwater_magma::UnderwaterMagmaFeature {
    ...
    map.insert(
        ...
        ConfiguredFeature::VoidStartPlatform(crate::generation::feature::features::void_start_platform::VoidStartPlatformFeature {}),
    );
    map.insert(
        ...
        ConfiguredFeature::SimpleRandomSelector(SimpleRandomFeature {
            features: vec![
                PlacedFeature { feature :
                Feature::Inlined(Box::new(ConfiguredFeature::CoralTree(crate
                ::generation::feature::features::coral::coral_tree::CoralTreeFeature))),
                placement : vec![], }, PlacedFeature { feature :
                Feature::Inlined(Box::new(ConfiguredFeature::CoralClaw(crate
                ::generation::feature::features::coral::coral_claw::CoralClawFeature))),
                placement : vec![], }, PlacedFeature { feature :
                Feature::Inlined(Box::new(ConfiguredFeature::CoralMushroom(crate
                ::generation::feature::features::coral::coral_mushroom::CoralMushroomFeature))),
                placement : vec![], }
            ],
        }),
    );
    map.insert(
        ...
        ConfiguredFeature::NetherForestVegetation(NetherForestVegetationFeature {
            state_provider: BlockStateProvider::Weighted(WeightedBlockStateProvider {
                entries: vec![
                    Weighted { data : pumpkin_data::Block::WARPED_ROOTS.default_state,
                    weight : 85i32 }, Weighted { data :
                    pumpkin_data::Block::CRIMSON_ROOTS.default_state, weight : 1i32 },
                    Weighted { data : pumpkin_data::Block::WARPED_FUNGUS.default_state,
                    weight : 13i32 }, Weighted { data :
                    pumpkin_data::Block::CRIMSON_FUNGUS.default_state, weight : 1i32 }
                ],
            }),
            spread_width: 8i32,
            spread_height: 4i32,
    ...
    map.insert(
        ...
        ConfiguredFeature::WeepingVines(crate::generation::feature::features::weeping_vines::WeepingVinesFeature {}),
    );
    map.insert(
        ...
        ConfiguredFeature::SimpleBlock(SimpleBlockFeature {
            to_place: BlockStateProvider::Weighted(WeightedBlockStateProvider {
                entries: vec![
                    ...
                    props.insert("flower_amount".to_string(), "1".to_string()); props
                    .insert("facing".to_string(), "north".to_string()); BlockStateCodec {
                    name : & pumpkin_data::Block::WILDFLOWERS, properties : Some(props),
                    } .get_state() }, weight : 1i32 }, Weighted { data : { let mut props
                    = std::collections::HashMap::new(); props.insert("flower_amount"
                    .to_string(), "1".to_string()); props.insert("facing".to_string(),
                    "east".to_string()); BlockStateCodec { name : &
                    pumpkin_data::Block::WILDFLOWERS, properties : Some(props), }
                    .get_state() }, weight : 1i32 }, Weighted { data : { let mut props =
                    std::collections::HashMap::new(); props.insert("flower_amount"
                    .to_string(), "1".to_string()); props.insert("facing".to_string(),
                    "south".to_string()); BlockStateCodec { name : &
